...
const Blog = () => {
    return (
        <>
            ...
            <div className="container-fluid mt-4" id="blog">
                ...
                <div className="row justify-content-center m-4">
                    <div className="col-12 col-md-5 col-lg-3 my-3 m-md-4 p-0 card h-100 card" id="code-website">
                    ...
                    <div className="col-12 col-md-5 col-lg-3 my-3 m-md-4 p-0 card" id="sell-web">
                    ...
                    <div className="col-12 col-md-5 col-lg-3 my-3 m-md-4 p-0 card" id="google-position">
                    ...
                    <div className="col-12 col-md-5 col-lg-3 my-3 m-md-4 p-0 card">
