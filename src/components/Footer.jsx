...
import linkedinImage from '../assets/linkedin_icon.png';
import xImage from '../assets/twitter_icon.png';
                    ...
                    <section className='col-12 col-md-5 col-lg-2 pb-2'>
                        ...
                        <Nav.Item className="d-inline">
                            <Nav.Link href="#" onClick={handleScrollToSection("github-infos", "github")} className='social-picture-link'>
                                <img src={githubImage} alt="icone de github" className='social-picture'/>
                            </Nav.Link>
                        </Nav.Item>
                        <a href="https://x.com/?lang=fr&mx=2" target='_blank' className='social-picture-link'><img src={xImage} alt="icone de X (ancien Twitter)" className='social-picture'/></a>
                        <a href="https://fr.linkedin.com/" target="_blank" className='social-picture-link'><img src={linkedinImage} alt="icone de LinkedIn" className='social-picture'/></a>
                    </section>
